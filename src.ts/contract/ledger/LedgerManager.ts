...
export interface LedgerManagerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "fineTuneAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface LedgerManager extends BaseContract {
  ...
  addLedger: TypedContractMethod<
    [signer: [BigNumberish, BigNumberish], additionalInfo: string],
    [[bigint, bigint]],
    "payable"
  >;
  ...
  fineTuneAddress: TypedContractMethod<[], [string], "view">;
  ...
  transferFund: TypedContractMethod<
    [provider: AddressLike, serviceType: string, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "fineTuneAddress"
