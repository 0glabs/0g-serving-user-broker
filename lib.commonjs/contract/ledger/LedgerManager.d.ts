...
export interface LedgerManagerInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "deleteLedger", values: [AddressLike]): string;
...
export interface LedgerManager extends BaseContract {
    ...
    deleteLedger: TypedContractMethod<[user: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "deleteLedger"): TypedContractMethod<[user: AddressLike], [void], "nonpayable">;
