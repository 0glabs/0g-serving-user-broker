...
export declare class InferenceServingContract {
    ...
    listAccount(): Promise<import("./inference/InferenceServing").AccountStructOutput[]>;
    getAccount(provider: AddressLike): Promise<import("./inference/InferenceServing").AccountStructOutput>;
