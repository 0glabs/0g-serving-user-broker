...
class ZGServingUserBrokerBase {
    ...
    async getHeader(providerAddress, svcName, content, outputFee) {
        try {
            ...
            const request = new Request$1(nonce.toString(), fee.toString(), this.contract.getUserAddress(), providerAddress);
...
class Provider {
    ...
    async createTask(modelHash, rootHash, isTurbo, providerAddress, serviceName, fee, trainingParams) {
        ...
        const response = await axios$1.post(endpoint, payload, {
            headers: {
                "Content-Type": "application/json",
            },
        });
    ...
    async getTaskProgress(providerAddress, serviceName, customerAddress) {
        ...
        const response = await axios$1.get(endpoint, { responseType: "arraybuffer" });
